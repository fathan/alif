...
<body>
	<div class="site-wrapper">
		...
		<section class="section about-management">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="list-user">
							<div class="image">
								<img src="assets/images/gallery/fathan.jpg" alt="">
								<div class="overlay">
						...
						<div class="list-user">
							<div class="image">
								<img src="assets/images/gallery/fathan2.jpg" alt="">
								<div class="overlay">
									<div class="box-profile">
										<div class="name">Fathan Rohman</div>
										<div class="position">Frontend Developer</div>
