<footer class="footer-wrapper">
	<section class="footer-one">
		<div class="f-content-one">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="box-list">
							<div class="list-section-content bg-alif-purple">
								<div class="icon">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3">
						...
						<form action="#">
							<input type="text" class="form-control" placeholder="Masukan e-mail anda disini...">
							<br>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="corpyright">
						<p>&copy; 2016 Al Ijarah Indonesia Finance. All Rights reserved</p>
					</div>
				</div>
			</div>
		</div>
